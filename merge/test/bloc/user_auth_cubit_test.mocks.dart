...
// in merge/test/bloc/user_auth_cubit_test.dart.
...
import 'package:merge/features/project/domain/user/entity/user.dart' as _i6;
...
class MockIUserRepository extends _i1.Mock implements _i3.IUserRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.User>> loginUser(
    String? email,
    String? password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, void>> signUpUser(_i6.User? user) =>
      (super.noSuchMethod(
        Invocation.method(
          #signUpUser,
          [user],
